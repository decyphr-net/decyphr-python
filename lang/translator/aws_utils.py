...
def _translate_text(text):
    ...
    response = _translator.translate_text(
        Text=text, SourceLanguageCode="pt", TargetLanguageCode="en")
    return response["TranslatedText"]


def bundle_aws_data(text):
    """
    ...
    """
    new_text = _translate_text(text)
    path_to_audio_file = _generate_audio_file(text)
    new_data = {
        "source_text": text,
